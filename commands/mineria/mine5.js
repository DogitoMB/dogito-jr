module.exports = {
  name: "mine", 
  aliases: ['m'], 
code: `$setGlobalUserVar[coins;$sum[$getGlobalUserVar[coins;$authorID];$random[90;100]];$authorID]
...
$footer[💵 +$$random[90;100] | 🗡 +$random[5;10]xp]
$globalCooldown[50s;Try again in %time%]
$onlyIf[$getGlobalUserVar[pico5;$authorID]==1;]
