module.exports = {
  name: "mine", 
  aliases: ['m'], 
code: `$setGlobalUserVar[coins;$sum[$getGlobalUserVar[coins;$authorID];$random[200;230]];$authorID]
...
$title[Cueva]
$description[
$username, fue de mineria con su $customEmoji[diamondpickaxe] y escabo alrededor de $random[10;30] bloques y consiguio $randomText[piedra comun;piedra;piedra;piedra;piedra;piedra;hierro;piedra;piedra;piedra;piedra;carbon]]
$footer[💵 +$$random[200;230] | 🗡 +$random[5;10]xp]
